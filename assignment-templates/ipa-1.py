...
def savings(gross_pay, tax_rate, expenses):
    ...
    '''
    # Replace `pass` with your code after_tax_pay = math.floor(gross_pay*tax_pay)
    after_tax_pay = (gross_pay- math.floor(gross_pay*tax_rate))
    diff = after_tax_pay - expenses
